...
def main():
    ...
    fig.suptitle('Análise de Tratamento de Estouro de Buffer no Cliente (DASH vs RTSP)', fontsize=16, fontweight='bold')
    ...
    # LEGENDA PARA FORA (Centro-Direita)
    ...
    # O bbox_inches='tight' garante que a imagem final abrace a legenda externa sem cortá-la
    plt.tight_layout()
