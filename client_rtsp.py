...
def main():
    ...
    def thread_rede_udp():
        ...
        while executando and (time.time() - tempo_inicio) < args.duration:
            ...
            # --- 5.3: TRATAMENTO DE ESTOURO (CONTROLE DE FLUXO DA APLICAÇÃO) ---
            # Como o UDP não tem controle de congestionamento, a aplicação assume esse papel
